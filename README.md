...
src/app/
  ...
  feroq/                 the consultancy landing page, linked from Experience
  layout.tsx             metadata, Open Graph, and the language provider
  icon.svg               favicon, generated by Next from this file
  sitemap.ts robots.ts   both routes; add a third here if one appears
cv/
